      ...
      <div class="fixed inset-0 overflow-hidden">
        <div class="absolute inset-0 bg-opacity-40 bg-zinc-800">
          <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full">
            <TransitionChild as="template" enter="transform transition ease-in-out duration-500 sm:duration-1000"
              enter-from="translate-x-full" enter-to="translate-x-0"
              leave="transform transition ease-in-out duration-500 sm:duration-1000" leave-from="translate-x-0"
              ...
              <DialogPanel
                ...
                <div v-if="$slots.title || $slots.description"
                  ...
                  <div class="flex items-start justify-between space-x-3">
                    <div class="space-y-1">
                      ...
                      <p v-if="$slots.description" class="text-sm text-zinc-500 dark:text-zinc-300">
                ...
                <!-- Content -->
                <div id="slide-over-content" class="flex h-full flex-col overflow-y-auto bg-white dark:bg-zinc-800">
                  <div :class="class">
                    <slot name="content" />
                  </div>
                </div>
