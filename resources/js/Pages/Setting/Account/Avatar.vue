...
<template>
  ...
  <div class="flex items-center justify-between">
    <div class="flex items-center space-x-4">
      <div>
        <img :src="user.photo_url" :alt="user.name" class="h-10 w-10 rounded-full" />
      </div>
      <div>
    ...
    <div v-if="user.media?.length >= 1" @click="destroy" class="p-2 hover:bg-zinc-100 rounded-md cursor-pointer">
